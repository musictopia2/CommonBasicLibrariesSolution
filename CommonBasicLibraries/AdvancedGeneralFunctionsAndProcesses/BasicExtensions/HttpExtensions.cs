namespace CommonBasicLibraries.AdvancedGeneralFunctionsAndProcesses.BasicExtensions
{
    public static class HttpExtensions
    {
        ...
        //will think about what extensions i use.  if there is a nuget package, just copy the code and not even use that nuget package (so i can have better ways of doing web api)
        //but still use more standard stuff.
