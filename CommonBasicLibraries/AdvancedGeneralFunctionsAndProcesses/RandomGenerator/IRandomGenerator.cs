namespace CommonBasicLibraries.AdvancedGeneralFunctionsAndProcesses.RandomGenerator
{
    public interface IRandomGenerator
    {
        ...
        int NextMillisecond();
        DateOnly NextDateOnly(DateOnly? min = null, DateOnly? max = null); //decided for now to do custom dates but not time.
        DateTime NextDateTime(DateTime? min = null, DateTime? max = null); //simple means dateonly
        //not sure if we need nexttimeonly (to do custom time alone)
