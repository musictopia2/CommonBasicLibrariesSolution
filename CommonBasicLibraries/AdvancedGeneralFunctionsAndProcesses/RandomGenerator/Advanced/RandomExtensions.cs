...
public static class RandomExtensions
{
    ...
    extension (IRandomNumberList random)
    {
        ...
        public string NextEmail(string? domain = null, int length = 7) => random.NextWord(length: length, syllablesCount: null) + "@" + (domain ?? random.NextDomainName());
        ...
        public string NextGeohash(int length = 7) => random.NextString(length, "0123456789bcdefghjkmnpqrstuvwxyz");
        ...
        public string NextIP() => $"{random.GetRandomNumber(254, 1)}.{random.GetRandomNumber(255, 0)}.{random.GetRandomNumber(255, 0)}.{random.GetRandomNumber(254, 0)}";
        ...
        public int NextMillisecond() => random.GetRandomNumber(999);
        ...
        public int NextSecond() => random.GetRandomNumber(59, 0);
        ...
        public string NextStreet(int syllables = 2, bool shortSuffix = true) => NextWord(random, syllablesCount: syllables).Capitalize + " " + (shortSuffix
        ...
        public string NextTwitterName() => $"@{random.NextWord()}";
        public string NextHashtag() => $"#{random.NextWord()}";
        public string NextDomainName(string? tld = null) => NextWord(random) + "." + (tld ?? NextTopLevelDomain(random));
        ...
        public string GetDigits(int howMany, int startAt = 0, int endAt = 9)
        {
        ...
        public string Password(RandomPasswordParameterClass thisPassword)
        {
        ...
        private string NextWord(bool capitalize = false, int? syllablesCount = 2, int? length = null)
        {
        ...
        internal (string Name, string Abb) StreetSuffix()
        {
    ...
    extension(IRandomNumberList)
    {
        internal static BasicList<int> GetPossibleIntegerList(int minValue, int maximumValue, int increments)
        {
        ...
        internal static int PrivateHowManyPossible(int maxNumber, int startingNumber, int previousCount, int setCount)
        {
